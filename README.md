...
**Nota:** Si prefieres usar el Care-Package sin ninguna de las herramientas que proporciona elimina los siguientes archivos del proyecto: `package.json` y `gulpfile.js`. Ahora ya puedes usar el Care-Package como punto de inicio y configurar tu propio build system.
...
El Web-Care-Package oficialmente brinda soporte a los siguientes navegadores:
...
El Web-Care-Package puede brindar soporte a navegadores mas antiguos si así lo deseas, por defecto esta enfocado en asegurarse de que los diseños funcionen bien en los mencionados anteriormente.
